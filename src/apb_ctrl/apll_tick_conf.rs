...
pub struct APLL_TICK_NUM_R(crate::FieldReader<u8, u8>);
impl APLL_TICK_NUM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APLL_TICK_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APLL_TICK_NUM_R {
