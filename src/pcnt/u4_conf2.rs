...
pub struct CNT_H_LIM_U4_R(crate::FieldReader<u16, u16>);
impl CNT_H_LIM_U4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CNT_H_LIM_U4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CNT_H_LIM_U4_R {
...
pub struct CNT_H_LIM_U4_W<'a> {
    w: &'a mut W,
}
impl<'a> CNT_H_LIM_U4_W<'a> {
...
pub struct CNT_L_LIM_U4_R(crate::FieldReader<u16, u16>);
impl CNT_L_LIM_U4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CNT_L_LIM_U4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CNT_L_LIM_U4_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct CNT_L_LIM_U4_W<'a> {
    w: &'a mut W,
}
impl<'a> CNT_L_LIM_U4_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl W {
    #[doc = "Bits 0:15 - This register is used to configure thr_h_lim value for unit4."]
    #[inline(always)]
    pub fn cnt_h_lim_u4(&mut self) -> CNT_H_LIM_U4_W {
        CNT_H_LIM_U4_W { w: self }
    }
    #[doc = "Bits 16:31 - This register is used to confiugre thr_l_lim value for unit4."]
    #[inline(always)]
    pub fn cnt_l_lim_u4(&mut self) -> CNT_L_LIM_U4_W {
        CNT_L_LIM_U4_W { w: self }
    }
