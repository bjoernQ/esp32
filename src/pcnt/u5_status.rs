...
pub struct CORE_STATUS_U5_R(crate::FieldReader<u32, u32>);
impl CORE_STATUS_U5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CORE_STATUS_U5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CORE_STATUS_U5_R {
...
impl R {
    ...
    pub fn core_status_u5(&self) -> CORE_STATUS_U5_R {
        CORE_STATUS_U5_R::new(self.bits as u32)
    }
}
