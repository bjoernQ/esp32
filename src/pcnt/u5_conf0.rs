...
pub struct FILTER_THRES_U5_R(crate::FieldReader<u16, u16>);
...
pub struct FILTER_EN_U5_R(crate::FieldReader<bool, bool>);
impl FILTER_EN_U5_R {
    #[inline(always)]
...
pub struct THR_ZERO_EN_U5_R(crate::FieldReader<bool, bool>);
...
pub struct THR_H_LIM_EN_U5_R(crate::FieldReader<bool, bool>);
...
pub struct THR_L_LIM_EN_U5_R(crate::FieldReader<bool, bool>);
...
pub struct THR_THRES0_EN_U5_R(crate::FieldReader<bool, bool>);
...
pub struct THR_THRES1_EN_U5_R(crate::FieldReader<bool, bool>);
...
pub struct CH0_NEG_MODE_U5_R(crate::FieldReader<u8, u8>);
...
pub struct CH0_POS_MODE_U5_R(crate::FieldReader<u8, u8>);
...
pub struct CH0_HCTRL_MODE_U5_R(crate::FieldReader<u8, u8>);
...
pub struct CH0_LCTRL_MODE_U5_R(crate::FieldReader<u8, u8>);
...
pub struct CH1_NEG_MODE_U5_R(crate::FieldReader<u8, u8>);
...
pub struct CH1_POS_MODE_U5_R(crate::FieldReader<u8, u8>);
...
pub struct CH1_HCTRL_MODE_U5_R(crate::FieldReader<u8, u8>);
...
pub struct CH1_LCTRL_MODE_U5_R(crate::FieldReader<u8, u8>);
...
impl R {
    ...
    pub fn thr_h_lim_en_u5(&self) -> THR_H_LIM_EN_U5_R {
        THR_H_LIM_EN_U5_R::new(((self.bits >> 12) & 0x01) != 0)
    }
    ...
    pub fn thr_l_lim_en_u5(&self) -> THR_L_LIM_EN_U5_R {
        THR_L_LIM_EN_U5_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    ...
    pub fn thr_thres0_en_u5(&self) -> THR_THRES0_EN_U5_R {
        THR_THRES0_EN_U5_R::new(((self.bits >> 14) & 0x01) != 0)
    }
    ...
    pub fn thr_thres1_en_u5(&self) -> THR_THRES1_EN_U5_R {
        THR_THRES1_EN_U5_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    ...
    pub fn ch0_neg_mode_u5(&self) -> CH0_NEG_MODE_U5_R {
        CH0_NEG_MODE_U5_R::new(((self.bits >> 16) & 0x03) as u8)
    }
    ...
    pub fn ch0_pos_mode_u5(&self) -> CH0_POS_MODE_U5_R {
        CH0_POS_MODE_U5_R::new(((self.bits >> 18) & 0x03) as u8)
    }
    ...
    pub fn ch0_hctrl_mode_u5(&self) -> CH0_HCTRL_MODE_U5_R {
        CH0_HCTRL_MODE_U5_R::new(((self.bits >> 20) & 0x03) as u8)
    }
    ...
    pub fn ch0_lctrl_mode_u5(&self) -> CH0_LCTRL_MODE_U5_R {
        CH0_LCTRL_MODE_U5_R::new(((self.bits >> 22) & 0x03) as u8)
    }
    ...
    pub fn ch1_neg_mode_u5(&self) -> CH1_NEG_MODE_U5_R {
        CH1_NEG_MODE_U5_R::new(((self.bits >> 24) & 0x03) as u8)
    }
    ...
    pub fn ch1_pos_mode_u5(&self) -> CH1_POS_MODE_U5_R {
        CH1_POS_MODE_U5_R::new(((self.bits >> 26) & 0x03) as u8)
    }
    ...
    pub fn ch1_hctrl_mode_u5(&self) -> CH1_HCTRL_MODE_U5_R {
        CH1_HCTRL_MODE_U5_R::new(((self.bits >> 28) & 0x03) as u8)
    }
    ...
    pub fn ch1_lctrl_mode_u5(&self) -> CH1_LCTRL_MODE_U5_R {
        CH1_LCTRL_MODE_U5_R::new(((self.bits >> 30) & 0x03) as u8)
    }
}
impl W {
    #[doc = "Bits 0:9 - This register is used to filter pluse whose width is smaller than this value for unit5."]
