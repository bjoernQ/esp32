...
pub struct CNT_THRES0_U7_R(crate::FieldReader<u16, u16>);
impl CNT_THRES0_U7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CNT_THRES0_U7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CNT_THRES0_U7_R {
...
pub struct CNT_THRES1_U7_R(crate::FieldReader<u16, u16>);
impl CNT_THRES1_U7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CNT_THRES1_U7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CNT_THRES1_U7_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
