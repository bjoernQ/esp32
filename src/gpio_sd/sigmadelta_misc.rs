...
pub struct GPIO_SPI_SWAP_R(crate::FieldReader<bool, bool>);
impl GPIO_SPI_SWAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        GPIO_SPI_SWAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_SPI_SWAP_R {
