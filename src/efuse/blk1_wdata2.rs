...
pub struct BLK1_DIN2_R(crate::FieldReader<u32, u32>);
impl BLK1_DIN2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK1_DIN2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK1_DIN2_R {
...
pub struct BLK1_DIN2_W<'a> {
    w: &'a mut W,
}
impl<'a> BLK1_DIN2_W<'a> {
...
impl R {
    ...
    pub fn blk1_din2(&self) -> BLK1_DIN2_R {
        BLK1_DIN2_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - program for BLOCK1"]
    #[inline(always)]
    pub fn blk1_din2(&mut self) -> BLK1_DIN2_W {
        BLK1_DIN2_W { w: self }
    }
