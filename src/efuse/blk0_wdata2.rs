...
pub struct WIFI_MAC_CRC_HIGH_R(crate::FieldReader<u32, u32>);
impl WIFI_MAC_CRC_HIGH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        WIFI_MAC_CRC_HIGH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WIFI_MAC_CRC_HIGH_R {
