...
pub struct BLK3_DIN1_R(crate::FieldReader<u32, u32>);
impl BLK3_DIN1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK3_DIN1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK3_DIN1_R {
...
impl R {
    ...
    pub fn blk3_din1(&self) -> BLK3_DIN1_R {
        BLK3_DIN1_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - program for BLOCK3"]
