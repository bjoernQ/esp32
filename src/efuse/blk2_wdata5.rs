...
pub struct BLK2_DIN5_R(crate::FieldReader<u32, u32>);
impl BLK2_DIN5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK2_DIN5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK2_DIN5_R {
...
pub struct BLK2_DIN5_W<'a> {
    w: &'a mut W,
}
impl<'a> BLK2_DIN5_W<'a> {
...
impl R {
    ...
    pub fn blk2_din5(&self) -> BLK2_DIN5_R {
        BLK2_DIN5_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - program for BLOCK2"]
    #[inline(always)]
    pub fn blk2_din5(&mut self) -> BLK2_DIN5_W {
        BLK2_DIN5_W { w: self }
    }
