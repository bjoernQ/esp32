...
pub struct BLK1_DIN7_R(crate::FieldReader<u32, u32>);
impl BLK1_DIN7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK1_DIN7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK1_DIN7_R {
...
impl R {
    ...
    pub fn blk1_din7(&self) -> BLK1_DIN7_R {
        BLK1_DIN7_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - program for BLOCK1"]
