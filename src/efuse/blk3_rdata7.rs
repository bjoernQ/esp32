...
pub struct BLK3_DOUT7_R(crate::FieldReader<u32, u32>);
impl BLK3_DOUT7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK3_DOUT7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK3_DOUT7_R {
...
impl R {
    ...
    pub fn blk3_dout7(&self) -> BLK3_DOUT7_R {
        BLK3_DOUT7_R::new(self.bits as u32)
    }
}
