...
pub struct BLK3_DOUT2_R(crate::FieldReader<u32, u32>);
impl BLK3_DOUT2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK3_DOUT2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK3_DOUT2_R {
...
impl R {
    ...
    pub fn blk3_dout2(&self) -> BLK3_DOUT2_R {
        BLK3_DOUT2_R::new(self.bits as u32)
    }
}
