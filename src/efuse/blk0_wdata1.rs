...
pub struct WIFI_MAC_CRC_LOW_R(crate::FieldReader<u32, u32>);
impl WIFI_MAC_CRC_LOW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        WIFI_MAC_CRC_LOW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WIFI_MAC_CRC_LOW_R {
...
impl R {
    ...
    pub fn wifi_mac_crc_low(&self) -> WIFI_MAC_CRC_LOW_R {
        WIFI_MAC_CRC_LOW_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - program for low 32bit WIFI_MAC_Address"]
