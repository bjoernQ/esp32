...
pub struct RD_WIFI_MAC_CRC_HIGH_R(crate::FieldReader<u32, u32>);
impl RD_WIFI_MAC_CRC_HIGH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        RD_WIFI_MAC_CRC_HIGH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RD_WIFI_MAC_CRC_HIGH_R {
