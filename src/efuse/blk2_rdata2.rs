...
pub struct BLK2_DOUT2_R(crate::FieldReader<u32, u32>);
impl BLK2_DOUT2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK2_DOUT2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK2_DOUT2_R {
...
impl R {
    ...
    pub fn blk2_dout2(&self) -> BLK2_DOUT2_R {
        BLK2_DOUT2_R::new(self.bits as u32)
    }
}
