...
pub struct BLK1_DOUT7_R(crate::FieldReader<u32, u32>);
impl BLK1_DOUT7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BLK1_DOUT7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BLK1_DOUT7_R {
...
impl R {
    ...
    pub fn blk1_dout7(&self) -> BLK1_DOUT7_R {
        BLK1_DOUT7_R::new(self.bits as u32)
    }
}
