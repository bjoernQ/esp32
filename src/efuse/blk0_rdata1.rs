...
pub struct RD_WIFI_MAC_CRC_LOW_R(crate::FieldReader<u32, u32>);
impl RD_WIFI_MAC_CRC_LOW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        RD_WIFI_MAC_CRC_LOW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RD_WIFI_MAC_CRC_LOW_R {
...
impl R {
    ...
    pub fn rd_wifi_mac_crc_low(&self) -> RD_WIFI_MAC_CRC_LOW_R {
        RD_WIFI_MAC_CRC_LOW_R::new(self.bits as u32)
    }
}
