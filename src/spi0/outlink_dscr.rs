...
pub struct DMA_OUTLINK_DSCR_R(crate::FieldReader<u32, u32>);
impl DMA_OUTLINK_DSCR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DMA_OUTLINK_DSCR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA_OUTLINK_DSCR_R {
...
impl R {
    ...
    pub fn dma_outlink_dscr(&self) -> DMA_OUTLINK_DSCR_R {
        DMA_OUTLINK_DSCR_R::new(self.bits as u32)
    }
}
