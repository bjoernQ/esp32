...
pub struct DMA_INLINK_DSCR_R(crate::FieldReader<u32, u32>);
impl DMA_INLINK_DSCR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DMA_INLINK_DSCR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMA_INLINK_DSCR_R {
...
impl R {
    ...
    pub fn dma_inlink_dscr(&self) -> DMA_INLINK_DSCR_R {
        DMA_INLINK_DSCR_R::new(self.bits as u32)
    }
}
