...
pub struct SLV_RDBUF_DBITLEN_R(crate::FieldReader<u32, u32>);
impl SLV_RDBUF_DBITLEN_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SLV_RDBUF_DBITLEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLV_RDBUF_DBITLEN_R {
