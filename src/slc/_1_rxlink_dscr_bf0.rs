...
pub struct SLC1_RXLINK_DSCR_BF0_R(crate::FieldReader<u32, u32>);
impl SLC1_RXLINK_DSCR_BF0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SLC1_RXLINK_DSCR_BF0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLC1_RXLINK_DSCR_BF0_R {
...
impl R {
    ...
    pub fn slc1_rxlink_dscr_bf0(&self) -> SLC1_RXLINK_DSCR_BF0_R {
        SLC1_RXLINK_DSCR_BF0_R::new(self.bits as u32)
    }
}
