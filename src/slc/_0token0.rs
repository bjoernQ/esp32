...
pub struct SLC0_TOKEN0_WDATA_W<'a> {
    w: &'a mut W,
}
impl<'a> SLC0_TOKEN0_WDATA_W<'a> {
...
pub struct SLC0_TOKEN0_WR_W<'a> {
    w: &'a mut W,
}
impl<'a> SLC0_TOKEN0_WR_W<'a> {
...
pub struct SLC0_TOKEN0_INC_W<'a> {
    w: &'a mut W,
}
impl<'a> SLC0_TOKEN0_INC_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct SLC0_TOKEN0_INC_MORE_W<'a> {
    w: &'a mut W,
}
impl<'a> SLC0_TOKEN0_INC_MORE_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub struct SLC0_TOKEN0_R(crate::FieldReader<u16, u16>);
impl SLC0_TOKEN0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        SLC0_TOKEN0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLC0_TOKEN0_R {
...
impl W {
    #[doc = "Bits 0:11"]
    #[inline(always)]
    pub fn slc0_token0_wdata(&mut self) -> SLC0_TOKEN0_WDATA_W {
        SLC0_TOKEN0_WDATA_W { w: self }
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    pub fn slc0_token0_wr(&mut self) -> SLC0_TOKEN0_WR_W {
        SLC0_TOKEN0_WR_W { w: self }
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    pub fn slc0_token0_inc(&mut self) -> SLC0_TOKEN0_INC_W {
        SLC0_TOKEN0_INC_W { w: self }
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    pub fn slc0_token0_inc_more(&mut self) -> SLC0_TOKEN0_INC_MORE_W {
        SLC0_TOKEN0_INC_MORE_W { w: self }
    }
