...
pub struct SLC0_TXLINK_DSCR_R(crate::FieldReader<u32, u32>);
impl SLC0_TXLINK_DSCR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SLC0_TXLINK_DSCR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLC0_TXLINK_DSCR_R {
...
impl R {
    ...
    pub fn slc0_txlink_dscr(&self) -> SLC0_TXLINK_DSCR_R {
        SLC0_TXLINK_DSCR_R::new(self.bits as u32)
    }
}
