...
pub struct CMD_CONTENT1_R(crate::FieldReader<u32, u32>);
impl CMD_CONTENT1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CMD_CONTENT1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CMD_CONTENT1_R {
...
impl R {
    ...
    pub fn cmd_content1(&self) -> CMD_CONTENT1_R {
        CMD_CONTENT1_R::new(self.bits as u32)
    }
}
