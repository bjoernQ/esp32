...
pub struct SLC0_RX_PKT_H_DSCR_ADDR_R(crate::FieldReader<u32, u32>);
impl SLC0_RX_PKT_H_DSCR_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SLC0_RX_PKT_H_DSCR_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLC0_RX_PKT_H_DSCR_ADDR_R {
...
impl R {
    ...
    pub fn slc0_rx_pkt_h_dscr_addr(&self) -> SLC0_RX_PKT_H_DSCR_ADDR_R {
        SLC0_RX_PKT_H_DSCR_ADDR_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
