...
pub struct SLC0_TX_PKT_END_DSCR_ADDR_R(crate::FieldReader<u32, u32>);
impl SLC0_TX_PKT_END_DSCR_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SLC0_TX_PKT_END_DSCR_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLC0_TX_PKT_END_DSCR_ADDR_R {
...
impl R {
    ...
    pub fn slc0_tx_pkt_end_dscr_addr(&self) -> SLC0_TX_PKT_END_DSCR_ADDR_R {
        SLC0_TX_PKT_END_DSCR_ADDR_R::new(self.bits as u32)
    }
}
