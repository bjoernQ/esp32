...
pub struct SLC1_TO_EOF_DES_ADDR_R(crate::FieldReader<u32, u32>);
impl SLC1_TO_EOF_DES_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SLC1_TO_EOF_DES_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLC1_TO_EOF_DES_ADDR_R {
...
impl R {
    ...
    pub fn slc1_to_eof_des_addr(&self) -> SLC1_TO_EOF_DES_ADDR_R {
        SLC1_TO_EOF_DES_ADDR_R::new(self.bits as u32)
    }
}
