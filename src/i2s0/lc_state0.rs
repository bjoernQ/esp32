...
pub struct LC_STATE0_R(crate::FieldReader<u32, u32>);
impl LC_STATE0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        LC_STATE0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LC_STATE0_R {
...
impl R {
    ...
    pub fn lc_state0(&self) -> LC_STATE0_R {
        LC_STATE0_R::new(self.bits as u32)
    }
}
