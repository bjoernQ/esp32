...
pub struct CVSD_SIGMA_MAX_R(crate::FieldReader<u16, u16>);
impl CVSD_SIGMA_MAX_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CVSD_SIGMA_MAX_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CVSD_SIGMA_MAX_R {
...
pub struct CVSD_SIGMA_MIN_R(crate::FieldReader<u16, u16>);
impl CVSD_SIGMA_MIN_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CVSD_SIGMA_MIN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CVSD_SIGMA_MIN_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
