...
pub struct SLEEP_CYCLES_S3_R(crate::FieldReader<u32, u32>);
impl SLEEP_CYCLES_S3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SLEEP_CYCLES_S3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLEEP_CYCLES_S3_R {
...
impl R {
    ...
    pub fn sleep_cycles_s3(&self) -> SLEEP_CYCLES_S3_R {
        SLEEP_CYCLES_S3_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
