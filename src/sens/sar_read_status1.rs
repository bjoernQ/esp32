...
pub struct SAR1_READER_STATUS_R(crate::FieldReader<u32, u32>);
impl SAR1_READER_STATUS_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SAR1_READER_STATUS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SAR1_READER_STATUS_R {
...
impl R {
    ...
    pub fn sar1_reader_status(&self) -> SAR1_READER_STATUS_R {
        SAR1_READER_STATUS_R::new(self.bits as u32)
    }
}
