...
pub struct TOUCH_OUT_TH5_R(crate::FieldReader<u16, u16>);
impl TOUCH_OUT_TH5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        TOUCH_OUT_TH5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_OUT_TH5_R {
...
pub struct TOUCH_OUT_TH4_R(crate::FieldReader<u16, u16>);
impl TOUCH_OUT_TH4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        TOUCH_OUT_TH4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TOUCH_OUT_TH4_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
