#[doc = "Register `SARADC_CTRL2` reader"]
pub struct R(crate::R<SARADC_CTRL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SARADC_CTRL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SARADC_CTRL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SARADC_CTRL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SARADC_CTRL2` writer"]
pub struct W(crate::W<SARADC_CTRL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SARADC_CTRL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SARADC_CTRL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SARADC_CTRL2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [saradc_ctrl2](index.html) module"]
pub struct SARADC_CTRL2_SPEC;
impl crate::RegisterSpec for SARADC_CTRL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [saradc_ctrl2::R](R) reader structure"]
impl crate::Readable for SARADC_CTRL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [saradc_ctrl2::W](W) writer structure"]
impl crate::Writable for SARADC_CTRL2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SARADC_CTRL2 to value 0x01fe"]
impl crate::Resettable for SARADC_CTRL2_SPEC {
    #[inline(always)]
