#[doc = "Register `SARADC_FSM` reader"]
pub struct R(crate::R<SARADC_FSM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SARADC_FSM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SARADC_FSM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SARADC_FSM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SARADC_FSM` writer"]
pub struct W(crate::W<SARADC_FSM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SARADC_FSM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SARADC_FSM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SARADC_FSM_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [saradc_fsm](index.html) module"]
pub struct SARADC_FSM_SPEC;
impl crate::RegisterSpec for SARADC_FSM_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [saradc_fsm::R](R) reader structure"]
impl crate::Readable for SARADC_FSM_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [saradc_fsm::W](W) writer structure"]
impl crate::Writable for SARADC_FSM_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SARADC_FSM to value 0x0208_ff08"]
impl crate::Resettable for SARADC_FSM_SPEC {
    #[inline(always)]
