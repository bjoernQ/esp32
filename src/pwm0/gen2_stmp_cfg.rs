...
pub struct GEN2_A_UPMETHOD_R(crate::FieldReader<u8, u8>);
impl GEN2_A_UPMETHOD_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        GEN2_A_UPMETHOD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GEN2_A_UPMETHOD_R {
...
pub struct GEN2_A_UPMETHOD_W<'a> {
    w: &'a mut W,
}
impl<'a> GEN2_A_UPMETHOD_W<'a> {
...
pub struct GEN2_B_UPMETHOD_R(crate::FieldReader<u8, u8>);
impl GEN2_B_UPMETHOD_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        GEN2_B_UPMETHOD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GEN2_B_UPMETHOD_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GEN2_B_UPMETHOD_W<'a> {
    w: &'a mut W,
}
impl<'a> GEN2_B_UPMETHOD_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct GEN2_A_SHDW_FULL_R(crate::FieldReader<bool, bool>);
impl GEN2_A_SHDW_FULL_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        GEN2_A_SHDW_FULL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GEN2_A_SHDW_FULL_R {
...
pub struct GEN2_A_SHDW_FULL_W<'a> {
    w: &'a mut W,
}
impl<'a> GEN2_A_SHDW_FULL_W<'a> {
...
pub struct GEN2_B_SHDW_FULL_R(crate::FieldReader<bool, bool>);
impl GEN2_B_SHDW_FULL_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        GEN2_B_SHDW_FULL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GEN2_B_SHDW_FULL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct GEN2_B_SHDW_FULL_W<'a> {
    w: &'a mut W,
}
impl<'a> GEN2_B_SHDW_FULL_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn gen2_a_shdw_full(&self) -> GEN2_A_SHDW_FULL_R {
        GEN2_A_SHDW_FULL_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn gen2_b_shdw_full(&self) -> GEN2_B_SHDW_FULL_R {
        GEN2_B_SHDW_FULL_R::new(((self.bits >> 9) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    pub fn gen2_a_upmethod(&mut self) -> GEN2_A_UPMETHOD_W {
        GEN2_A_UPMETHOD_W { w: self }
    }
    #[doc = "Bits 4:7"]
    #[inline(always)]
    pub fn gen2_b_upmethod(&mut self) -> GEN2_B_UPMETHOD_W {
        GEN2_B_UPMETHOD_W { w: self }
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn gen2_a_shdw_full(&mut self) -> GEN2_A_SHDW_FULL_W {
        GEN2_A_SHDW_FULL_W { w: self }
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn gen2_b_shdw_full(&mut self) -> GEN2_B_SHDW_FULL_W {
        GEN2_B_SHDW_FULL_W { w: self }
    }
