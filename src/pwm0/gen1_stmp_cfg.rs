...
impl GEN1_A_UPMETHOD_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        GEN1_A_UPMETHOD_R(crate::FieldReader::new(bits))
    }
}
...
impl GEN1_B_UPMETHOD_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        GEN1_B_UPMETHOD_R(crate::FieldReader::new(bits))
    }
}
...
impl GEN1_A_SHDW_FULL_R {
    ...
    pub(crate) fn new(bits: bool) -> Self {
        GEN1_A_SHDW_FULL_R(crate::FieldReader::new(bits))
    }
}
...
impl GEN1_B_SHDW_FULL_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        GEN1_B_SHDW_FULL_R(crate::FieldReader::new(bits))
    }
}
