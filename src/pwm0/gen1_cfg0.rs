...
pub struct GEN1_CFG_UPMETHOD_R(crate::FieldReader<u8, u8>);
...
pub struct GEN1_T0_SEL_R(crate::FieldReader<u8, u8>);
impl GEN1_T0_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct GEN1_T1_SEL_R(crate::FieldReader<u8, u8>);
impl GEN1_T1_SEL_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
