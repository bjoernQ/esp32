...
pub struct INLINK_DSCR_BF1_R(crate::FieldReader<u32, u32>);
impl INLINK_DSCR_BF1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        INLINK_DSCR_BF1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INLINK_DSCR_BF1_R {
...
impl R {
    ...
    pub fn inlink_dscr_bf1(&self) -> INLINK_DSCR_BF1_R {
        INLINK_DSCR_BF1_R::new(self.bits as u32)
    }
}
