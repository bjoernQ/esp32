...
pub struct SHA384_BUSY_R(crate::FieldReader<bool, bool>);
impl SHA384_BUSY_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        SHA384_BUSY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SHA384_BUSY_R {
...
impl R {
    ...
    pub fn sha384_busy(&self) -> SHA384_BUSY_R {
        SHA384_BUSY_R::new((self.bits & 0x01) != 0)
    }
}
