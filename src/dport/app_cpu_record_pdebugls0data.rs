...
pub struct RECORD_APP_PDEBUGLS0DATA_R(crate::FieldReader<u32, u32>);
impl RECORD_APP_PDEBUGLS0DATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        RECORD_APP_PDEBUGLS0DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RECORD_APP_PDEBUGLS0DATA_R {
...
impl R {
    ...
    pub fn record_app_pdebugls0data(&self) -> RECORD_APP_PDEBUGLS0DATA_R {
        RECORD_APP_PDEBUGLS0DATA_R::new(self.bits as u32)
    }
}
