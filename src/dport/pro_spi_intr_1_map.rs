...
pub struct PRO_SPI_INTR_1_MAP_R(crate::FieldReader<u8, u8>);
impl PRO_SPI_INTR_1_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PRO_SPI_INTR_1_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_SPI_INTR_1_MAP_R {
