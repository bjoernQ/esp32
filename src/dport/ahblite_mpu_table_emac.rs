...
pub struct EMAC_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl EMAC_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        EMAC_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EMAC_ACCESS_GRANT_CONFIG_R {
...
pub struct EMAC_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> EMAC_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn emac_access_grant_config(&mut self) -> EMAC_ACCESS_GRANT_CONFIG_W {
        EMAC_ACCESS_GRANT_CONFIG_W { w: self }
    }
