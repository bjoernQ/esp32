...
pub struct APP_INTR_STATUS_1_R(crate::FieldReader<u32, u32>);
impl APP_INTR_STATUS_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APP_INTR_STATUS_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_INTR_STATUS_1_R {
...
impl R {
    ...
    pub fn app_intr_status_1(&self) -> APP_INTR_STATUS_1_R {
        APP_INTR_STATUS_1_R::new(self.bits as u32)
    }
}
