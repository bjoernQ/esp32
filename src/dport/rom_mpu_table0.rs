...
pub struct ROM_MPU_TABLE0_R(crate::FieldReader<u8, u8>);
impl ROM_MPU_TABLE0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ROM_MPU_TABLE0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ROM_MPU_TABLE0_R {
