...
pub struct SRAM_FO_0_R(crate::FieldReader<u32, u32>);
impl SRAM_FO_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SRAM_FO_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SRAM_FO_0_R {
...
impl R {
    ...
    pub fn sram_fo_0(&self) -> SRAM_FO_0_R {
        SRAM_FO_0_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
