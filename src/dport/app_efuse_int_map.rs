...
pub struct APP_EFUSE_INT_MAP_R(crate::FieldReader<u8, u8>);
impl APP_EFUSE_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APP_EFUSE_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_EFUSE_INT_MAP_R {
