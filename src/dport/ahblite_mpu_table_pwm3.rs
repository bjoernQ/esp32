...
pub struct PWM3_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl PWM3_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PWM3_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PWM3_ACCESS_GRANT_CONFIG_R {
