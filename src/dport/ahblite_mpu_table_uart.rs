...
pub struct UART_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl UART_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        UART_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UART_ACCESS_GRANT_CONFIG_R {
...
pub struct UART_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> UART_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn uart_access_grant_config(&mut self) -> UART_ACCESS_GRANT_CONFIG_W {
        UART_ACCESS_GRANT_CONFIG_W { w: self }
    }
