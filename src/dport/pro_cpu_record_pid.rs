...
pub struct RECORD_PRO_PID_R(crate::FieldReader<u8, u8>);
impl RECORD_PRO_PID_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RECORD_PRO_PID_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RECORD_PRO_PID_R {
