...
pub struct APP_CACHE_VADDR_R(crate::FieldReader<u32, u32>);
impl APP_CACHE_VADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APP_CACHE_VADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_CACHE_VADDR_R {
