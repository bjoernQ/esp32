...
pub struct EFUSE_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl EFUSE_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        EFUSE_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EFUSE_ACCESS_GRANT_CONFIG_R {
