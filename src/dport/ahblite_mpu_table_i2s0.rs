...
pub struct I2S0_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl I2S0_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        I2S0_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for I2S0_ACCESS_GRANT_CONFIG_R {
