...
pub struct SHROM_MPU_TABLE17_R(crate::FieldReader<u8, u8>);
impl SHROM_MPU_TABLE17_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SHROM_MPU_TABLE17_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SHROM_MPU_TABLE17_R {
