...
pub struct PRO_INTR_STATUS_0_R(crate::FieldReader<u32, u32>);
impl PRO_INTR_STATUS_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_INTR_STATUS_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_INTR_STATUS_0_R {
...
impl R {
    ...
    pub fn pro_intr_status_0(&self) -> PRO_INTR_STATUS_0_R {
        PRO_INTR_STATUS_0_R::new(self.bits as u32)
    }
}
