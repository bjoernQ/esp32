...
pub struct BTMAC_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl BTMAC_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        BTMAC_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BTMAC_ACCESS_GRANT_CONFIG_R {
...
pub struct BTMAC_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> BTMAC_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn btmac_access_grant_config(&mut self) -> BTMAC_ACCESS_GRANT_CONFIG_W {
        BTMAC_ACCESS_GRANT_CONFIG_W { w: self }
    }
