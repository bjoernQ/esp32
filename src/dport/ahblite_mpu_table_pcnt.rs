...
pub struct PCNT_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl PCNT_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PCNT_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PCNT_ACCESS_GRANT_CONFIG_R {
...
pub struct PCNT_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> PCNT_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn pcnt_access_grant_config(&mut self) -> PCNT_ACCESS_GRANT_CONFIG_W {
        PCNT_ACCESS_GRANT_CONFIG_W { w: self }
    }
