...
pub struct PRO_SPI_INTR_3_MAP_R(crate::FieldReader<u8, u8>);
impl PRO_SPI_INTR_3_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PRO_SPI_INTR_3_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_SPI_INTR_3_MAP_R {
...
pub struct PRO_SPI_INTR_3_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_SPI_INTR_3_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn pro_spi_intr_3_map(&mut self) -> PRO_SPI_INTR_3_MAP_W {
        PRO_SPI_INTR_3_MAP_W { w: self }
    }
