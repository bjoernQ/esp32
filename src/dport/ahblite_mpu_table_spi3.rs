...
pub struct SPI3_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl SPI3_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SPI3_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPI3_ACCESS_GRANT_CONFIG_R {
...
pub struct SPI3_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> SPI3_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn spi3_access_grant_config(&mut self) -> SPI3_ACCESS_GRANT_CONFIG_W {
        SPI3_ACCESS_GRANT_CONFIG_W { w: self }
    }
