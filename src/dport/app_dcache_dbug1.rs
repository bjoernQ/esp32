...
pub struct APP_CTAG_RAM_RDATA_R(crate::FieldReader<u32, u32>);
impl APP_CTAG_RAM_RDATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APP_CTAG_RAM_RDATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_CTAG_RAM_RDATA_R {
...
impl R {
    ...
    pub fn app_ctag_ram_rdata(&self) -> APP_CTAG_RAM_RDATA_R {
        APP_CTAG_RAM_RDATA_R::new(self.bits as u32)
    }
}
