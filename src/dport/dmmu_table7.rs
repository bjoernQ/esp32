...
pub struct DMMU_TABLE7_R(crate::FieldReader<u8, u8>);
impl DMMU_TABLE7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        DMMU_TABLE7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DMMU_TABLE7_R {
...
pub struct DMMU_TABLE7_W<'a> {
    w: &'a mut W,
}
impl<'a> DMMU_TABLE7_W<'a> {
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn dmmu_table7(&mut self) -> DMMU_TABLE7_W {
        DMMU_TABLE7_W { w: self }
    }
