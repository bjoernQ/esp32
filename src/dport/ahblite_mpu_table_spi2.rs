...
pub struct SPI2_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl SPI2_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SPI2_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPI2_ACCESS_GRANT_CONFIG_R {
