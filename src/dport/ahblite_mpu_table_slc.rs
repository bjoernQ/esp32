...
pub struct SLC_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl SLC_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SLC_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SLC_ACCESS_GRANT_CONFIG_R {
...
pub struct SLC_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> SLC_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn slc_access_grant_config(&mut self) -> SLC_ACCESS_GRANT_CONFIG_W {
        SLC_ACCESS_GRANT_CONFIG_W { w: self }
    }
