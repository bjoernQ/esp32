...
pub struct APP_INTRUSION_RECORD_R(crate::FieldReader<u8, u8>);
impl APP_INTRUSION_RECORD_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APP_INTRUSION_RECORD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_INTRUSION_RECORD_R {
