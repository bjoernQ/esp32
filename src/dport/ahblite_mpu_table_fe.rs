...
pub struct FE_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl FE_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        FE_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FE_ACCESS_GRANT_CONFIG_R {
...
pub struct FE_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> FE_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn fe_access_grant_config(&mut self) -> FE_ACCESS_GRANT_CONFIG_W {
        FE_ACCESS_GRANT_CONFIG_W { w: self }
    }
