...
pub struct APP_UART1_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl APP_UART1_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APP_UART1_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_UART1_INTR_MAP_R {
...
pub struct APP_UART1_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> APP_UART1_INTR_MAP_W<'a> {
