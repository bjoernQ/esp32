...
pub struct RTC_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl RTC_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        RTC_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTC_ACCESS_GRANT_CONFIG_R {
...
pub struct RTC_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> RTC_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn rtc_access_grant_config(&mut self) -> RTC_ACCESS_GRANT_CONFIG_W {
        RTC_ACCESS_GRANT_CONFIG_W { w: self }
    }
