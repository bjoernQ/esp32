...
pub struct TIMER_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl TIMER_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TIMER_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER_ACCESS_GRANT_CONFIG_R {
