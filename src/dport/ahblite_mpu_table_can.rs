...
pub struct CAN_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl CAN_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CAN_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CAN_ACCESS_GRANT_CONFIG_R {
...
pub struct CAN_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> CAN_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn can_access_grant_config(&mut self) -> CAN_ACCESS_GRANT_CONFIG_W {
        CAN_ACCESS_GRANT_CONFIG_W { w: self }
    }
