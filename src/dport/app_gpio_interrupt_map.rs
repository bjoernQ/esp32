...
pub struct APP_GPIO_INTERRUPT_APP_MAP_R(crate::FieldReader<u8, u8>);
impl APP_GPIO_INTERRUPT_APP_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APP_GPIO_INTERRUPT_APP_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_GPIO_INTERRUPT_APP_MAP_R {
