...
pub struct IMMU_TABLE4_R(crate::FieldReader<u8, u8>);
impl IMMU_TABLE4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IMMU_TABLE4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IMMU_TABLE4_R {
...
pub struct IMMU_TABLE4_W<'a> {
    w: &'a mut W,
}
impl<'a> IMMU_TABLE4_W<'a> {
...
impl W {
    #[doc = "Bits 0:6"]
    #[inline(always)]
    pub fn immu_table4(&mut self) -> IMMU_TABLE4_W {
        IMMU_TABLE4_W { w: self }
    }
