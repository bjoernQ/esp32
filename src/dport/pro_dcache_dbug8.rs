...
pub struct PRO_IROM0ADDR_IA_R(crate::FieldReader<u32, u32>);
impl PRO_IROM0ADDR_IA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_IROM0ADDR_IA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_IROM0ADDR_IA_R {
