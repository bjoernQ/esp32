...
pub struct APPDPORT_APB_MASK0_R(crate::FieldReader<u32, u32>);
impl APPDPORT_APB_MASK0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APPDPORT_APB_MASK0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APPDPORT_APB_MASK0_R {
...
pub struct APPDPORT_APB_MASK0_W<'a> {
    w: &'a mut W,
}
impl<'a> APPDPORT_APB_MASK0_W<'a> {
...
impl R {
    ...
    pub fn appdport_apb_mask0(&self) -> APPDPORT_APB_MASK0_R {
        APPDPORT_APB_MASK0_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn appdport_apb_mask0(&mut self) -> APPDPORT_APB_MASK0_W {
        APPDPORT_APB_MASK0_W { w: self }
    }
