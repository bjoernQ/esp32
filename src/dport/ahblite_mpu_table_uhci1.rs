...
pub struct UHCI1_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl UHCI1_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        UHCI1_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UHCI1_ACCESS_GRANT_CONFIG_R {
