...
pub struct APP_TRACEMEM_ENA_R(crate::FieldReader<bool, bool>);
impl APP_TRACEMEM_ENA_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        APP_TRACEMEM_ENA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_TRACEMEM_ENA_R {
