...
pub struct APP_MMU_IA_INT_MAP_R(crate::FieldReader<u8, u8>);
impl APP_MMU_IA_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APP_MMU_IA_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_MMU_IA_INT_MAP_R {
...
pub struct APP_MMU_IA_INT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> APP_MMU_IA_INT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn app_mmu_ia_int_map(&mut self) -> APP_MMU_IA_INT_MAP_W {
        APP_MMU_IA_INT_MAP_W { w: self }
    }
