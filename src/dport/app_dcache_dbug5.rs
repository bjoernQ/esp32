...
pub struct APP_DROM0ADDR0_IA_R(crate::FieldReader<u32, u32>);
impl APP_DROM0ADDR0_IA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APP_DROM0ADDR0_IA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_DROM0ADDR0_IA_R {
