...
pub struct RECORD_APP_PDEBUGDATA_R(crate::FieldReader<u32, u32>);
impl RECORD_APP_PDEBUGDATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        RECORD_APP_PDEBUGDATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RECORD_APP_PDEBUGDATA_R {
...
impl R {
    ...
    pub fn record_app_pdebugdata(&self) -> RECORD_APP_PDEBUGDATA_R {
        RECORD_APP_PDEBUGDATA_R::new(self.bits as u32)
    }
}
