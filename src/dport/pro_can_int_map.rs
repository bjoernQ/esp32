...
pub struct PRO_CAN_INT_MAP_R(crate::FieldReader<u8, u8>);
impl PRO_CAN_INT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PRO_CAN_INT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_CAN_INT_MAP_R {
