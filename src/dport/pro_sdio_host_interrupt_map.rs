...
pub struct PRO_SDIO_HOST_INTERRUPT_MAP_R(crate::FieldReader<u8, u8>);
impl PRO_SDIO_HOST_INTERRUPT_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        PRO_SDIO_HOST_INTERRUPT_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_SDIO_HOST_INTERRUPT_MAP_R {
...
pub struct PRO_SDIO_HOST_INTERRUPT_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> PRO_SDIO_HOST_INTERRUPT_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn pro_sdio_host_interrupt_map(&mut self) -> PRO_SDIO_HOST_INTERRUPT_MAP_W {
        PRO_SDIO_HOST_INTERRUPT_MAP_W { w: self }
    }
