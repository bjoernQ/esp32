...
pub struct PRO_IRAM0ADDR_IA_R(crate::FieldReader<u32, u32>);
impl PRO_IRAM0ADDR_IA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_IRAM0ADDR_IA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_IRAM0ADDR_IA_R {
