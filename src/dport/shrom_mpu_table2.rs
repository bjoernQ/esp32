...
pub struct SHROM_MPU_TABLE2_R(crate::FieldReader<u8, u8>);
impl SHROM_MPU_TABLE2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SHROM_MPU_TABLE2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SHROM_MPU_TABLE2_R {
...
pub struct SHROM_MPU_TABLE2_W<'a> {
    w: &'a mut W,
}
impl<'a> SHROM_MPU_TABLE2_W<'a> {
...
impl R {
    ...
    pub fn shrom_mpu_table2(&self) -> SHROM_MPU_TABLE2_R {
        SHROM_MPU_TABLE2_R::new((self.bits & 0x03) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn shrom_mpu_table2(&mut self) -> SHROM_MPU_TABLE2_W {
        SHROM_MPU_TABLE2_W { w: self }
    }
