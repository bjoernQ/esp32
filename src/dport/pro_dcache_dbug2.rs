...
pub struct PRO_CACHE_VADDR_R(crate::FieldReader<u32, u32>);
impl PRO_CACHE_VADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PRO_CACHE_VADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PRO_CACHE_VADDR_R {
