...
pub struct TIMERGROUP_ACCESS_GRANT_CONFIG_R(crate::FieldReader<u8, u8>);
impl TIMERGROUP_ACCESS_GRANT_CONFIG_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TIMERGROUP_ACCESS_GRANT_CONFIG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMERGROUP_ACCESS_GRANT_CONFIG_R {
...
pub struct TIMERGROUP_ACCESS_GRANT_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMERGROUP_ACCESS_GRANT_CONFIG_W<'a> {
...
impl W {
    ...
    pub fn timergroup_access_grant_config(&mut self) -> TIMERGROUP_ACCESS_GRANT_CONFIG_W {
        TIMERGROUP_ACCESS_GRANT_CONFIG_W { w: self }
    }
