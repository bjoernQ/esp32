...
pub struct APP_PWM1_INTR_MAP_R(crate::FieldReader<u8, u8>);
impl APP_PWM1_INTR_MAP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        APP_PWM1_INTR_MAP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APP_PWM1_INTR_MAP_R {
...
pub struct APP_PWM1_INTR_MAP_W<'a> {
    w: &'a mut W,
}
impl<'a> APP_PWM1_INTR_MAP_W<'a> {
...
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn app_pwm1_intr_map(&mut self) -> APP_PWM1_INTR_MAP_W {
        APP_PWM1_INTR_MAP_W { w: self }
    }
