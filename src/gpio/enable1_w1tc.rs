...
pub struct ENABLE1_DATA_W1TC_R(crate::FieldReader<u8, u8>);
impl ENABLE1_DATA_W1TC_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        ENABLE1_DATA_W1TC_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ENABLE1_DATA_W1TC_R {
