...
pub struct APPCPU_NMI_INT_R(crate::FieldReader<u32, u32>);
impl APPCPU_NMI_INT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APPCPU_NMI_INT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APPCPU_NMI_INT_R {
...
impl R {
    ...
    pub fn appcpu_nmi_int(&self) -> APPCPU_NMI_INT_R {
        APPCPU_NMI_INT_R::new(self.bits as u32)
    }
}
