...
pub struct ENABLE_DATA_W1TS_R(crate::FieldReader<u32, u32>);
impl ENABLE_DATA_W1TS_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        ENABLE_DATA_W1TS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ENABLE_DATA_W1TS_R {
...
impl R {
    ...
    pub fn enable_data_w1ts(&self) -> ENABLE_DATA_W1TS_R {
        ENABLE_DATA_W1TS_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - GPIO0~31 output enable write 1 to set"]
