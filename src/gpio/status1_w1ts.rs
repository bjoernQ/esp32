...
pub struct STATUS1_INT_W1TS_R(crate::FieldReader<u8, u8>);
impl STATUS1_INT_W1TS_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        STATUS1_INT_W1TS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for STATUS1_INT_W1TS_R {
