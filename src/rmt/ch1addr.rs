...
#[doc = "Field `APB_MEM_ADDR_CH1` reader - The ram relative address in channel1 by apb fifo access"]
pub struct APB_MEM_ADDR_CH1_R(crate::FieldReader<u32, u32>);
impl APB_MEM_ADDR_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        APB_MEM_ADDR_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for APB_MEM_ADDR_CH1_R {
...
impl R {
    ...
    pub fn apb_mem_addr_ch1(&self) -> APB_MEM_ADDR_CH1_R {
        APB_MEM_ADDR_CH1_R::new(self.bits as u32)
    }
}
