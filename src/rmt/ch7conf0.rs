...
impl R {
    ...
    pub fn carrier_en_ch7(&self) -> CARRIER_EN_CH7_R {
        CARRIER_EN_CH7_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    ...
    pub fn carrier_out_lv_ch7(&self) -> CARRIER_OUT_LV_CH7_R {
        CARRIER_OUT_LV_CH7_R::new(((self.bits >> 29) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - This register is used to configure the frequency divider's factor in channel7."]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch7conf0](index.html) module"]
pub struct CH7CONF0_SPEC;
impl crate::RegisterSpec for CH7CONF0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch7conf0::R](R) reader structure"]
impl crate::Readable for CH7CONF0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch7conf0::W](W) writer structure"]
