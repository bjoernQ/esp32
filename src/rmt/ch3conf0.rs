...
#[doc = "Field `DIV_CNT_CH3` reader - This register is used to configure the frequency divider's factor in channel3."]
...
#[doc = "Field `DIV_CNT_CH3` writer - This register is used to configure the frequency divider's factor in channel3."]
...
#[doc = "Field `IDLE_THRES_CH3` reader - In receive mode when the counter's value is bigger than reg_idle_thres_ch3 then the receive process is done."]
...
#[doc = "Field `IDLE_THRES_CH3` writer - In receive mode when the counter's value is bigger than reg_idle_thres_ch3 then the receive process is done."]
...
#[doc = "Field `MEM_SIZE_CH3` reader - This register is used to configure the the amount of memory blocks allocated to channel3."]
...
#[doc = "Field `MEM_SIZE_CH3` writer - This register is used to configure the the amount of memory blocks allocated to channel3."]
...
#[doc = "Field `CARRIER_EN_CH3` reader - This is the carrier modulation enable control bit for channel3."]
...
#[doc = "Field `CARRIER_EN_CH3` writer - This is the carrier modulation enable control bit for channel3."]
...
#[doc = "Field `CARRIER_OUT_LV_CH3` reader - This bit is used to configure carrier wave's position for channel3.1'b1:add on low level 1'b0:add on high level."]
...
#[doc = "Field `CARRIER_OUT_LV_CH3` writer - This bit is used to configure carrier wave's position for channel3.1'b1:add on low level 1'b0:add on high level."]
