...
impl R {
    ...
    pub fn mem_wr_rst_ch4(&self) -> MEM_WR_RST_CH4_R {
        MEM_WR_RST_CH4_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    ...
    pub fn mem_rd_rst_ch4(&self) -> MEM_RD_RST_CH4_R {
        MEM_RD_RST_CH4_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    ...
    pub fn apb_mem_rst_ch4(&self) -> APB_MEM_RST_CH4_R {
        APB_MEM_RST_CH4_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    ...
    pub fn mem_owner_ch4(&self) -> MEM_OWNER_CH4_R {
        MEM_OWNER_CH4_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    ...
    pub fn ref_cnt_rst_ch4(&self) -> REF_CNT_RST_CH4_R {
        REF_CNT_RST_CH4_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    ...
    pub fn ref_always_on_ch4(&self) -> REF_ALWAYS_ON_CH4_R {
        REF_ALWAYS_ON_CH4_R::new(((self.bits >> 17) & 0x01) != 0)
    }
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch4conf1](index.html) module"]
pub struct CH4CONF1_SPEC;
impl crate::RegisterSpec for CH4CONF1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch4conf1::R](R) reader structure"]
impl crate::Readable for CH4CONF1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch4conf1::W](W) writer structure"]
