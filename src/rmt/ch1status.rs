...
#[doc = "Field `STATUS_CH1` reader - The status for channel1"]
pub struct STATUS_CH1_R(crate::FieldReader<u32, u32>);
impl STATUS_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        STATUS_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for STATUS_CH1_R {
...
#[doc = "Field `MEM_WADDR_EX_CH1` reader - The current memory read address of channel1."]
pub struct MEM_WADDR_EX_CH1_R(crate::FieldReader<u16, u16>);
impl MEM_WADDR_EX_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        MEM_WADDR_EX_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MEM_WADDR_EX_CH1_R {
...
#[doc = "Field `MEM_RADDR_EX_CH1` reader - The current memory write address of channel1."]
...
#[doc = "Field `STATE_CH1` reader - The channel1 state machine status register.3'h0 : idle, 3'h1 : send, 3'h2 : read memory, 3'h3 : receive, 3'h4 : wait."]
...
#[doc = "Field `MEM_OWNER_ERR_CH1` reader - When channel1 is configured for receive mode, this bit will turn to high level if rmt_mem_owner register is not set to 1."]
pub struct MEM_OWNER_ERR_CH1_R(crate::FieldReader<bool, bool>);
impl MEM_OWNER_ERR_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        MEM_OWNER_ERR_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MEM_OWNER_ERR_CH1_R {
...
#[doc = "Field `MEM_FULL_CH1` reader - The memory full status bit for channel1 turns to high level when mem_waddr_ex is greater than or equal to the configuration range."]
pub struct MEM_FULL_CH1_R(crate::FieldReader<bool, bool>);
impl MEM_FULL_CH1_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        MEM_FULL_CH1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MEM_FULL_CH1_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `MEM_EMPTY_CH1` reader - The memory empty status bit for channel1. in acyclic mode, this bit turns to high level when mem_raddr_ex is greater than or equal to the configured range."]
...
#[doc = "Field `APB_MEM_WR_ERR_CH1` reader - The apb write memory status bit for channel1 turns to high level when the apb write address exceeds the configuration range."]
...
#[doc = "Field `APB_MEM_RD_ERR_CH1` reader - The apb read memory status bit for channel1 turns to high level when the apb read address exceeds the configuration range."]
...
impl R {
    ...
    #[inline(always)]
    pub fn status_ch1(&self) -> STATUS_CH1_R {
        STATUS_CH1_R::new(self.bits as u32)
    }
    #[doc = "Bits 0:9 - The current memory read address of channel1."]
    #[inline(always)]
    pub fn mem_waddr_ex_ch1(&self) -> MEM_WADDR_EX_CH1_R {
        MEM_WADDR_EX_CH1_R::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bits 12:21 - The current memory write address of channel1."]
    #[inline(always)]
    pub fn mem_raddr_ex_ch1(&self) -> MEM_RADDR_EX_CH1_R {
        MEM_RADDR_EX_CH1_R::new(((self.bits >> 12) & 0x03ff) as u16)
    }
    ...
    pub fn state_ch1(&self) -> STATE_CH1_R {
        STATE_CH1_R::new(((self.bits >> 24) & 0x07) as u8)
    }
    ...
    #[inline(always)]
    pub fn mem_owner_err_ch1(&self) -> MEM_OWNER_ERR_CH1_R {
        MEM_OWNER_ERR_CH1_R::new(((self.bits >> 27) & 0x01) != 0)
    }
    ...
    #[inline(always)]
    pub fn mem_full_ch1(&self) -> MEM_FULL_CH1_R {
        MEM_FULL_CH1_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    ...
    pub fn mem_empty_ch1(&self) -> MEM_EMPTY_CH1_R {
        MEM_EMPTY_CH1_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    ...
    pub fn apb_mem_wr_err_ch1(&self) -> APB_MEM_WR_ERR_CH1_R {
        APB_MEM_WR_ERR_CH1_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    ...
    pub fn apb_mem_rd_err_ch1(&self) -> APB_MEM_RD_ERR_CH1_R {
        APB_MEM_RD_ERR_CH1_R::new(((self.bits >> 31) & 0x01) != 0)
    }
}
