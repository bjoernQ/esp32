...
#[doc = "Field `CARRIER_LOW_CH0` reader - This register is used to configure carrier wave's low level value for channel0."]
...
#[doc = "Field `CARRIER_LOW_CH0` writer - This register is used to configure carrier wave's low level value for channel0."]
...
#[doc = "Field `CARRIER_HIGH_CH0` reader - This register is used to configure carrier wave's high level value for channel0."]
...
#[doc = "Field `CARRIER_HIGH_CH0` writer - This register is used to configure carrier wave's high level value for channel0."]
