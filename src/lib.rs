#![doc = "Peripheral access API for ESP32 microcontrollers (generated using svd2rust v0.19.0 (f4b0e64 2021-11-02))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Interrupt {
    ...
    pub fn try_from(value: u16) -> Result<Self, TryFromInterruptError> {
        match value {
            ...
            41 => Ok(Interrupt::PWM2),
            42 => Ok(Interrupt::PWM3),
...
#[doc = "eFuse Controller"]
pub mod efuse;
#[doc = "Peripheral FLASH_ENCRYPTION"]
...
impl PWM2 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const pwm0::RegisterBlock = 0x3ff6_f000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const pwm0::RegisterBlock {
        Self::PTR
...
impl PWM3 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const pwm0::RegisterBlock = 0x3ff7_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const pwm0::RegisterBlock {
        Self::PTR
...
impl SYSCON {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const syscon::RegisterBlock = 0x3ff6_6000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
