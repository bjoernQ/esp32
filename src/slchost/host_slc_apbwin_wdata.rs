...
pub struct HOST_SLC_APBWIN_WDATA_R(crate::FieldReader<u32, u32>);
impl HOST_SLC_APBWIN_WDATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        HOST_SLC_APBWIN_WDATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLC_APBWIN_WDATA_R {
...
pub struct HOST_SLC_APBWIN_WDATA_W<'a> {
    w: &'a mut W,
}
impl<'a> HOST_SLC_APBWIN_WDATA_W<'a> {
...
impl R {
    ...
    pub fn host_slc_apbwin_wdata(&self) -> HOST_SLC_APBWIN_WDATA_R {
        HOST_SLC_APBWIN_WDATA_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn host_slc_apbwin_wdata(&mut self) -> HOST_SLC_APBWIN_WDATA_W {
        HOST_SLC_APBWIN_WDATA_W { w: self }
    }
