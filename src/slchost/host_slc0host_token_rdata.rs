...
pub struct HOST_SLC0_TOKEN0_R(crate::FieldReader<u16, u16>);
impl HOST_SLC0_TOKEN0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        HOST_SLC0_TOKEN0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLC0_TOKEN0_R {
...
pub struct HOST_SLC0_RX_PF_VALID_R(crate::FieldReader<bool, bool>);
impl HOST_SLC0_RX_PF_VALID_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        HOST_SLC0_RX_PF_VALID_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLC0_RX_PF_VALID_R {
...
pub struct HOST_HOSTSLC0_TOKEN1_R(crate::FieldReader<u16, u16>);
impl HOST_HOSTSLC0_TOKEN1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        HOST_HOSTSLC0_TOKEN1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_HOSTSLC0_TOKEN1_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct HOST_SLC0_RX_PF_EOF_R(crate::FieldReader<u8, u8>);
impl HOST_SLC0_RX_PF_EOF_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        HOST_SLC0_RX_PF_EOF_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLC0_RX_PF_EOF_R {
