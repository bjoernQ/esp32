...
pub struct HOST_GPIO_SDIO_IN0_R(crate::FieldReader<u32, u32>);
impl HOST_GPIO_SDIO_IN0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        HOST_GPIO_SDIO_IN0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_GPIO_SDIO_IN0_R {
...
impl R {
    ...
    pub fn host_gpio_sdio_in0(&self) -> HOST_GPIO_SDIO_IN0_R {
        HOST_GPIO_SDIO_IN0_R::new(self.bits as u32)
    }
}
