...
impl R {
    ...
    pub fn host_fn1_slc1_wifi_rx_new_packet_int_ena(
        ...
        HOST_FN1_SLC1_WIFI_RX_NEW_PACKET_INT_ENA_R::new(((self.bits >> 23) & 0x01) != 0)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn host_fn1_slc1_host_rd_retry_int_ena(&self) -> HOST_FN1_SLC1_HOST_RD_RETRY_INT_ENA_R {
        HOST_FN1_SLC1_HOST_RD_RETRY_INT_ENA_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    pub fn host_fn1_slc1_bt_rx_new_packet_int_ena(
        ...
        HOST_FN1_SLC1_BT_RX_NEW_PACKET_INT_ENA_R::new(((self.bits >> 25) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0"]
