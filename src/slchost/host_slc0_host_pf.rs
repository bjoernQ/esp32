...
pub struct HOST_SLC0_PF_DATA_R(crate::FieldReader<u32, u32>);
impl HOST_SLC0_PF_DATA_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        HOST_SLC0_PF_DATA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLC0_PF_DATA_R {
...
impl R {
    ...
    pub fn host_slc0_pf_data(&self) -> HOST_SLC0_PF_DATA_R {
        HOST_SLC0_PF_DATA_R::new(self.bits as u32)
    }
}
