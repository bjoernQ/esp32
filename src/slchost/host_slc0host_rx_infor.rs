...
pub struct HOST_SLC0HOST_RX_INFOR_R(crate::FieldReader<u32, u32>);
impl HOST_SLC0HOST_RX_INFOR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        HOST_SLC0HOST_RX_INFOR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLC0HOST_RX_INFOR_R {
