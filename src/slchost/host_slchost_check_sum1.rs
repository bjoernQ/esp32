...
pub struct HOST_SLCHOST_CHECK_SUM1_R(crate::FieldReader<u32, u32>);
impl HOST_SLCHOST_CHECK_SUM1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        HOST_SLCHOST_CHECK_SUM1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLCHOST_CHECK_SUM1_R {
...
impl R {
    ...
    pub fn host_slchost_check_sum1(&self) -> HOST_SLCHOST_CHECK_SUM1_R {
        HOST_SLCHOST_CHECK_SUM1_R::new(self.bits as u32)
    }
}
