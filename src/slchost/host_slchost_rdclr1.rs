...
pub struct HOST_SLCHOST_SLC1_BIT7_CLRADDR_R(crate::FieldReader<u16, u16>);
impl HOST_SLCHOST_SLC1_BIT7_CLRADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        HOST_SLCHOST_SLC1_BIT7_CLRADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLCHOST_SLC1_BIT7_CLRADDR_R {
...
pub struct HOST_SLCHOST_SLC1_BIT7_CLRADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> HOST_SLCHOST_SLC1_BIT7_CLRADDR_W<'a> {
...
pub struct HOST_SLCHOST_SLC1_BIT6_CLRADDR_R(crate::FieldReader<u16, u16>);
impl HOST_SLCHOST_SLC1_BIT6_CLRADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        HOST_SLCHOST_SLC1_BIT6_CLRADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for HOST_SLCHOST_SLC1_BIT6_CLRADDR_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct HOST_SLCHOST_SLC1_BIT6_CLRADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> HOST_SLCHOST_SLC1_BIT6_CLRADDR_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl W {
    #[doc = "Bits 0:8"]
    #[inline(always)]
    pub fn host_slchost_slc1_bit7_clraddr(&mut self) -> HOST_SLCHOST_SLC1_BIT7_CLRADDR_W {
        HOST_SLCHOST_SLC1_BIT7_CLRADDR_W { w: self }
    }
    #[doc = "Bits 9:17"]
    #[inline(always)]
    pub fn host_slchost_slc1_bit6_clraddr(&mut self) -> HOST_SLCHOST_SLC1_BIT6_CLRADDR_W {
        HOST_SLCHOST_SLC1_BIT6_CLRADDR_W { w: self }
    }
