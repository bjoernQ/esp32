...
pub struct SCRATCH2_R(crate::FieldReader<u32, u32>);
impl SCRATCH2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SCRATCH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCRATCH2_R {
...
impl R {
    ...
    pub fn scratch2(&self) -> SCRATCH2_R {
        SCRATCH2_R::new(self.bits as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - 32-bit general purpose retention register"]
    #[inline(always)]
    pub fn scratch2(&mut self) -> SCRATCH2_W {
        SCRATCH2_W { w: self }
    }
