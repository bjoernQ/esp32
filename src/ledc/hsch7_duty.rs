...
#[doc = "Field `DUTY_HSCH7` reader - This register represents the current duty of the output signal for high speed channel7."]
pub struct DUTY_HSCH7_R(crate::FieldReader<u32, u32>);
impl DUTY_HSCH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DUTY_HSCH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DUTY_HSCH7_R {
