...
#[doc = "Field `DUTY_SCALE_LSCH5` reader - This register controls the increase or decrease step scale for low speed channel5."]
...
#[doc = "Field `DUTY_SCALE_LSCH5` writer - This register controls the increase or decrease step scale for low speed channel5."]
...
#[doc = "Field `DUTY_CYCLE_LSCH5` reader - This register is used to increase or decrease the duty every reg_duty_cycle_lsch5 cycles for low speed channel4."]
...
#[doc = "Field `DUTY_CYCLE_LSCH5` writer - This register is used to increase or decrease the duty every reg_duty_cycle_lsch5 cycles for low speed channel4."]
...
#[doc = "Field `DUTY_NUM_LSCH5` reader - This register is used to control the num of increased or decreased times for low speed channel5."]
...
#[doc = "Field `DUTY_NUM_LSCH5` writer - This register is used to control the num of increased or decreased times for low speed channel5."]
...
#[doc = "Field `DUTY_INC_LSCH5` reader - This register is used to increase the duty of output signal or decrease the duty of output signal for low speed channel5."]
...
#[doc = "Field `DUTY_INC_LSCH5` writer - This register is used to increase the duty of output signal or decrease the duty of output signal for low speed channel5."]
...
#[doc = "Field `DUTY_START_LSCH5` reader - When reg_duty_num_hsch4 reg_duty_cycle_hsch4 and reg_duty_scale_hsch4 has been configured. these register won't take effect until set reg_duty_start_hsch4. this bit is automatically cleared by hardware."]
...
#[doc = "Field `DUTY_START_LSCH5` writer - When reg_duty_num_hsch4 reg_duty_cycle_hsch4 and reg_duty_scale_hsch4 has been configured. these register won't take effect until set reg_duty_start_hsch4. this bit is automatically cleared by hardware."]
