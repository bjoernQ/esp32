...
pub struct DUTY_SCALE_HSCH7_R(crate::FieldReader<u16, u16>);
impl DUTY_SCALE_HSCH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DUTY_SCALE_HSCH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DUTY_SCALE_HSCH7_R {
...
pub struct DUTY_SCALE_HSCH7_W<'a> {
    w: &'a mut W,
}
impl<'a> DUTY_SCALE_HSCH7_W<'a> {
...
pub struct DUTY_CYCLE_HSCH7_R(crate::FieldReader<u16, u16>);
impl DUTY_CYCLE_HSCH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DUTY_CYCLE_HSCH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DUTY_CYCLE_HSCH7_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DUTY_CYCLE_HSCH7_W<'a> {
    w: &'a mut W,
}
impl<'a> DUTY_CYCLE_HSCH7_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
pub struct DUTY_NUM_HSCH7_R(crate::FieldReader<u16, u16>);
impl DUTY_NUM_HSCH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DUTY_NUM_HSCH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DUTY_NUM_HSCH7_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DUTY_NUM_HSCH7_W<'a> {
    w: &'a mut W,
}
impl<'a> DUTY_NUM_HSCH7_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
pub struct DUTY_INC_HSCH7_R(crate::FieldReader<bool, bool>);
impl DUTY_INC_HSCH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DUTY_INC_HSCH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DUTY_INC_HSCH7_R {
...
pub struct DUTY_INC_HSCH7_W<'a> {
    w: &'a mut W,
}
impl<'a> DUTY_INC_HSCH7_W<'a> {
...
pub struct DUTY_START_HSCH7_R(crate::FieldReader<bool, bool>);
impl DUTY_START_HSCH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        DUTY_START_HSCH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DUTY_START_HSCH7_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct DUTY_START_HSCH7_W<'a> {
    w: &'a mut W,
}
impl<'a> DUTY_START_HSCH7_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn duty_inc_hsch7(&self) -> DUTY_INC_HSCH7_R {
        DUTY_INC_HSCH7_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    ...
    pub fn duty_start_hsch7(&self) -> DUTY_START_HSCH7_R {
        DUTY_START_HSCH7_R::new(((self.bits >> 31) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:9 - This register controls the increase or decrease step scale for high speed channel7."]
