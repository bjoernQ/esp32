...
#[doc = "Field `DUTY_SCALE_LSCH1` reader - This register controls the increase or decrease step scale for low speed channel1."]
...
#[doc = "Field `DUTY_SCALE_LSCH1` writer - This register controls the increase or decrease step scale for low speed channel1."]
...
#[doc = "Field `DUTY_CYCLE_LSCH1` reader - This register is used to increase or decrease the duty every reg_duty_cycle_lsch1 cycles for low speed channel1."]
...
#[doc = "Field `DUTY_CYCLE_LSCH1` writer - This register is used to increase or decrease the duty every reg_duty_cycle_lsch1 cycles for low speed channel1."]
...
#[doc = "Field `DUTY_NUM_LSCH1` reader - This register is used to control the num of increased or decreased times for low speed channel1."]
...
#[doc = "Field `DUTY_NUM_LSCH1` writer - This register is used to control the num of increased or decreased times for low speed channel1."]
...
#[doc = "Field `DUTY_INC_LSCH1` reader - This register is used to increase the duty of output signal or decrease the duty of output signal for low speed channel1."]
...
#[doc = "Field `DUTY_INC_LSCH1` writer - This register is used to increase the duty of output signal or decrease the duty of output signal for low speed channel1."]
...
#[doc = "Field `DUTY_START_LSCH1` reader - When reg_duty_num_hsch1 reg_duty_cycle_hsch1 and reg_duty_scale_hsch1 has been configured. these register won't take effect until set reg_duty_start_hsch1. this bit is automatically cleared by hardware."]
...
#[doc = "Field `DUTY_START_LSCH1` writer - When reg_duty_num_hsch1 reg_duty_cycle_hsch1 and reg_duty_scale_hsch1 has been configured. these register won't take effect until set reg_duty_start_hsch1. this bit is automatically cleared by hardware."]
...
impl R {
    #[doc = "Bits 0:9 - This register controls the increase or decrease step scale for low speed channel1."]
    #[inline(always)]
    pub fn duty_scale_lsch1(&self) -> DUTY_SCALE_LSCH1_R {
        DUTY_SCALE_LSCH1_R::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bits 10:19 - This register is used to increase or decrease the duty every reg_duty_cycle_lsch1 cycles for low speed channel1."]
    #[inline(always)]
    pub fn duty_cycle_lsch1(&self) -> DUTY_CYCLE_LSCH1_R {
        DUTY_CYCLE_LSCH1_R::new(((self.bits >> 10) & 0x03ff) as u16)
    }
    #[doc = "Bits 20:29 - This register is used to control the num of increased or decreased times for low speed channel1."]
    #[inline(always)]
    pub fn duty_num_lsch1(&self) -> DUTY_NUM_LSCH1_R {
        DUTY_NUM_LSCH1_R::new(((self.bits >> 20) & 0x03ff) as u16)
    }
    #[doc = "Bit 30 - This register is used to increase the duty of output signal or decrease the duty of output signal for low speed channel1."]
    #[inline(always)]
